...
const styles = StyleSheet.create({
  ...
  summaryCard: { flex: 1, padding: Platform.select({ ios: 16, android: 12 }), borderRadius: 12, marginBottom: 10 },
  summaryLabel: { fontSize: Platform.select({ ios: 12, android: 10 }), fontWeight: '500', marginBottom: Platform.select({ ios: 4, android: 2 }) },
  summaryAmount: { fontSize: Platform.select({ ios: 18, android: 13 }), fontWeight: '700', marginBottom: Platform.select({ ios: 4, android: 2 }) },
